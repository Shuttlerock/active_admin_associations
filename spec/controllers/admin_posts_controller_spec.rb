...
describe Admin::PostsController, type: :controller do
  ...
  describe 'relate a tag' do
    ...
    it { is_expected.to set_flash.to('The recored has been related.') }
  ...
  describe 'unrelate a tag' do
    ...
    it { is_expected.to respond_with(:redirect) }
    it { is_expected.to set_flash.to('The recored has been unrelated.') }
  ...
  describe 'page related' do
    ...
    it { is_expected.to render_template('admin/shared/_collection_table') }
  end
end
